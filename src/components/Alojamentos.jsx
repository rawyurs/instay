...
const Alojamentos = ({ alojamentosData, alojamentosAleatorios }) => {
  ...
  // é chamada quando se clica no botão de ver detalhes
  const handleDetalhesClick = (alojamento) => {
    setAlojamentoSelecionado(alojamento);
  };
  //define alojamento selecionado para null (sair da página de detalhes)
  const resetAlojamentoSelecionado = () => {
    setAlojamentoSelecionado(null);
  };

  // garantir que  alojamentosData existe e que a propriedade results também | results fica com o array dos resultados de alojamentos da API 
    ...
    <section className="offer container section">
      <div className="secContainer">
        {alojamentoSelecionado ? (
          // se o alojamentoSelecionado existir renderiza o componente detalhes
          <Detalhes alojamento={alojamentoSelecionado} onClose={resetAlojamentoSelecionado} />
        ) : (
          // se o alojamentoSelecionado estiver null renderiza os alojamentos
